...
PB_INIT_CONTENT = '''"""Committed Python protobuf bindings for proto/altavista/v1.
...
def generate() -> None:
    ...
    for d in PACKAGE_DIRS:
        init = d / "__init__.py"
        if d == OUT_DIR:
            init.write_text(PB_INIT_CONTENT)
    ...
    print(f"grpcio-tools: {_pkg_version('grpcio-tools')}")
