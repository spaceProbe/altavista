...
fn sampled_runs_are_byte_identical_across_two_runs_with_the_same_seed() {
    ...
    let cfg_a = RunConfig { gmat: &gmat, drm: &drm_a, sos: &sos_a, systems: &systems, run_id: "gates-det-a".to_string(), error_mode: ExecutionErrorMode::Sampled , products_dir: None, replay: None, command_source: None };
    ...
    let cfg_b = RunConfig { gmat: &gmat, drm: &drm_b, sos: &sos_b, systems: &systems, run_id: "gates-det-b".to_string(), error_mode: ExecutionErrorMode::Sampled , products_dir: None, replay: None, command_source: None };
...
fn a_zero_sigma_execution_error_block_reproduces_the_perfect_burn_golden_bit_for_bit() {
    ...
    let cfg_perfect = RunConfig { gmat: &gmat, drm: &drm_perfect, sos: &sos_perfect, systems: &systems, run_id: "gates-perfect".to_string(), error_mode: ExecutionErrorMode::Nominal , products_dir: None, replay: None, command_source: None };
    ...
    let cfg_zero = RunConfig { gmat: &gmat, drm: &drm_zero, sos: &sos_zero, systems: &systems, run_id: "gates-zero".to_string(), error_mode: ExecutionErrorMode::Nominal , products_dir: None, replay: None, command_source: None };
...
fn a_nominal_plain_run_with_a_non_zero_gates_block_reproduces_the_perfect_burn_golden_bit_for_bit() {
    ...
    let cfg_perfect = RunConfig { gmat: &gmat, drm: &drm_perfect, sos: &sos_perfect, systems: &systems, run_id: "gates-nominal-nonzero-perfect".to_string(), error_mode: ExecutionErrorMode::Nominal , products_dir: None, replay: None, command_source: None };
    let products_perfect = execute(cfg_perfect).expect("perfect burn executes");
    ...
    let cfg_nonzero = RunConfig { gmat: &gmat, drm: &drm_nonzero, sos: &sos_nonzero, systems: &systems, run_id: "gates-nominal-nonzero".to_string(), error_mode: ExecutionErrorMode::Nominal , products_dir: None, replay: None, command_source: None };
...
fn a_sampled_covariance_run_injects_nothing() {
    ...
    let cfg_none = RunConfig { gmat: &gmat, drm: &drm_none, sos: &sos_none, systems: &systems, run_id: "gates-sampled-cov-none".to_string(), error_mode: ExecutionErrorMode::Sampled , products_dir: None, replay: None, command_source: None };
    ...
    let cfg_ee = RunConfig { gmat: &gmat, drm: &drm_ee, sos: &sos_ee, systems: &systems, run_id: "gates-sampled-cov-ee".to_string(), error_mode: ExecutionErrorMode::Sampled , products_dir: None, replay: None, command_source: None };
...
fn adding_a_second_maneuver_event_does_not_shift_the_first_ones_sampled_draw() {
    ...
    let cfg_solo = RunConfig { gmat: &gmat, drm: &drm_solo, sos: &sos_solo, systems: &systems, run_id: "gates-indep-solo".to_string(), error_mode: ExecutionErrorMode::Sampled , products_dir: None, replay: None, command_source: None };
    ...
    let cfg_both = RunConfig { gmat: &gmat, drm: &drm_both, sos: &sos_both, systems: &systems, run_id: "gates-indep-both".to_string(), error_mode: ExecutionErrorMode::Sampled , products_dir: None, replay: None, command_source: None };
...
fn the_covariance_path_injects_exactly_the_analytic_gates_term_at_the_burn_epoch() {
    ...
    let cfg_none = RunConfig { gmat: &gmat, drm: &drm_none, sos: &sos_none, systems: &systems, run_id: "gates-cov-none".to_string(), error_mode: ExecutionErrorMode::Nominal , products_dir: None, replay: None, command_source: None };
    let products_none = execute(cfg_none).expect("no-execution-error covariance run executes");
    ...
    let cfg_ee = RunConfig { gmat: &gmat, drm: &drm_ee, sos: &sos_ee, systems: &systems, run_id: "gates-cov-ee".to_string(), error_mode: ExecutionErrorMode::Nominal , products_dir: None, replay: None, command_source: None };
