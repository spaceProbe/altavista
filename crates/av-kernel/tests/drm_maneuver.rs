...
fn drm_matches_the_maneuver_golden_vnb_burn() {
    ...
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-maneuver-golden".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn drm_matches_the_maneuver_golden_ric_burn() {
    ...
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-maneuver-golden-ric".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn drm_maneuver_axes_kind_vvlh_does_not_reproduce_gmats_native_lvlh_burn() {
    ...
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-maneuver-golden-vvlh-as-vvlh".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn drm_maneuver_axes_kind_ric_reproduces_gmats_native_lvlh_burn() {
    ...
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-maneuver-golden-vvlh-as-ric".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn a_maneuver_splits_the_run_and_the_kept_boundary_sample_is_the_post_burn_one() {
    ...
    systems.insert(sys.id.clone(), sys);
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-accel-maneuver".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn a_maneuver_epoch_off_the_sample_grid_is_refused_before_any_binding() {
    ...
    systems.insert(sys.id.clone(), sys);
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-mvr-offgrid".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn a_maneuver_naming_an_unknown_instance_is_refused() {
    ...
    systems.insert(sys.id.clone(), sys);
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-mvr-unknown".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
    let err = execute(cfg).unwrap_err();
...
fn a_maneuver_with_an_unsupported_frame_is_refused_through_the_full_executor() {
    ...
    systems.insert(sys.id.clone(), sys);
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-mvr-frame".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
    let err = execute(cfg).unwrap_err();
...
fn a_maneuver_naming_a_native_instance_with_an_empty_state_space_is_a_typed_refusal_not_a_panic() {
    ...
    systems.insert(sys.id.clone(), sys);
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-mvr-empty".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
    let err = execute(cfg).unwrap_err();
    assert!(
...
fn covariance_is_unchanged_across_a_no_execution_error_burn() {
    ...
    let cfg_burn = RunConfig { gmat: &gmat, drm: &drm_burn, sos: &sos_burn, systems: &systems, run_id: "test-run-cov-zero-burn".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
    ...
    let cfg_plain = RunConfig { gmat: &gmat, drm: &drm_plain, sos: &sos_plain, systems: &systems, run_id: "test-run-cov-no-burn".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn a_maneuver_on_the_sample_grid_but_off_a_coarser_covariance_grid_is_refused() {
    ...
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-run-cov-offgrid-burn".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
    let err = execute(cfg).unwrap_err();
    assert!(
