...
fn run(run_id: &str) -> RunProducts {
    ...
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: run_id.to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
