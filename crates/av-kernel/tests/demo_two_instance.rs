...
fn together_products() -> &'static RunProducts {
    ...
    ONCE.get_or_init(|| {
        ...
        let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-demo-together".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn demo_two_instance_signal_port_delivers_a_drag_sail_command_that_measurably_changes_the_arc() {
    ...
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg_nc = RunConfig { gmat: &gmat, drm: &drm_nc, sos: &sos_nc, systems: &systems, run_id: "test-demo-flt-uncommanded".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn demo_two_instance_bystander_invariance_against_real_single_instance_gmat_runs() {
    ...
    let cfg_flt = RunConfig { gmat: &gmat, drm: &drm_flt, sos: &sos_flt, systems: &systems, run_id: "test-demo-flt-alone".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
    ...
    let cfg_mvr = RunConfig { gmat: &gmat, drm: &drm_mvr, sos: &sos_mvr, systems: &systems, run_id: "test-demo-mvr-alone".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
    ...
    let cfg_nf = RunConfig { gmat: &gmat, drm: &drm_flt_nf, sos: &sos_flt_nf, systems: &systems, run_id: "test-demo-flt-no-fault".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn covariance_is_declared_on_demo_mvr_only_and_the_asymmetry_is_load_bearing() {
    ...
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm_cov, sos: &sos_probe, systems: &systems, run_id: "test-demo-cov-probe".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
    ...
    let cfg_mvr_cov = RunConfig { gmat: &gmat, drm: &drm_mvr_cov, sos: &sos_mvr_cov, systems: &systems, run_id: "test-demo-mvr-cov".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
"#;
    ...
    let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-declared-frame-wins".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
...
fn icrf_products() -> &'static RunProducts {
    ...
    ONCE.get_or_init(|| {
        ...
        let gmat = Gmat::setup(&Gmat::default_startup_file()).expect("GMAT setup");
        let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &all_systems, run_id: "test-icrf-probe".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
