...
fn a_maneuver_never_merges_its_own_boundary_even_when_the_dynamics_hash_is_unchanged() {
    ...
    let cfg = RunConfig { gmat: &gmat, drm: &drm, sos: &sos, systems: &systems, run_id: "test-segment-merge-maneuver".to_string(), error_mode: Default::default() , products_dir: None, replay: None, command_source: None };
